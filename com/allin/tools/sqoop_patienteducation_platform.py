...
# 生成sqoop语句
def get_table():
    db = pymysql.connect(host='docker-base.mysql.rds.aliyuncs.com', user="dev", password='vi&F&fbs', port=3317,database="information_schema")
...
def get_colume(tablename):
   ...
   db1 = pymysql.connect(host="docker-base.mysql.rds.aliyuncs.com", user="dev", password="vi&F&fbs", port=3317,database="information_schema")
   cur = db1.cursor()
