...
if [ $? -eq 0 ];then
    hive -e "alter table ods.ods_patienteducation_cms_patient_education_20190108 add if not exists partition(dt='"""${etl_date}"""');"
else
    exit 1
fi