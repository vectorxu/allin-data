...
CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_case_folder_baseinfo` (
  ...
  `doctor_id` bigint COMMENT '主管医生id'
) COMMENT '病例主表'
PARTITIONED BY (
  `dt` string)
ROW FORMAT SERDE
...
CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_comm_data_dictionary` (
  `id` bigint COMMENT '',
  `dictionary_id` bigint COMMENT '字典id',
  `dictionary_type` int COMMENT '字典类型(1-病历夹)',
  `dictionary_name` string COMMENT '字典名称、数据项名称',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_comm_data_dictionary';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_comm_data_field` (
  `id` bigint COMMENT '',
  `field_id` bigint COMMENT '字段id',
  `dictionary_id` bigint COMMENT '关联字典id',
  `field_name` string COMMENT '字段名称',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_comm_data_field';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_comm_data_threshold` (
  `id` bigint COMMENT '',
  `threshold_id` bigint COMMENT '阈值id',
  `field_id` bigint COMMENT '字段id',
  `dictionary_id` bigint COMMENT '字典id',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_comm_data_threshold';
...
CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_log_team_baseinfo` (
  `id` bigint COMMENT '',
  `team_id` bigint COMMENT '团队id',
  `team_name` string COMMENT '团队名称',
  `creator_id` bigint COMMENT '创建人customer_id',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_log_team_baseinfo';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_log_team_member` (
  `id` bigint COMMENT '',
  `customer_id` bigint COMMENT '成员id',
  `team_id` bigint COMMENT '团队id',
  `customer_state` int COMMENT '成员状态 0-待审核  1-审核通过 2-待用户确认 3-审核拒绝',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_log_team_member';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_patient_number` (
  `id` bigint COMMENT '',
  `number_id` bigint COMMENT '编号id',
  `case_id` bigint COMMENT '病例id',
  `number_type` int COMMENT '编号类别1-住院号2-床位号3-病历号4-身份证号5-军官号',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_patient_number';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_team_baseinfo` (
  `id` bigint COMMENT '',
  `team_id` bigint COMMENT '团队id',
  `team_name` string COMMENT '团队名称',
  `creator_id` bigint COMMENT '创建人customer_id',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_team_baseinfo';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_team_baseinfo_bak20190110` (
  `id` bigint COMMENT '',
  `team_id` bigint COMMENT '团队id',
  `team_name` string COMMENT '团队名称',
  `creator_id` bigint COMMENT '创建人customer_id',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_team_baseinfo_bak20190110';

CREATE EXTERNAL TABLE IF NOT EXISTS `ods.ods_team_member` (
  `id` bigint COMMENT '',
  `customer_id` bigint COMMENT '成员id',
  `team_id` bigint COMMENT '团队id',
  `customer_state` int COMMENT '成员状态 0-待审核  1-审核通过 2-待用户确认 3-审核拒绝',
  `customer_role` int COMMENT '成员角色1-成员,2-所有者,3-医助',
  `sort_id` int COMMENT '排序',
  `site_id` int COMMENT '站点',
  `create_time` timestamp COMMENT '申请时间',
  `update_time` timestamp COMMENT '审核时间',
...
OUTPUTFORMAT
  'org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat'
LOCATION
  'hdfs://allincluster/user/hive/data/ods/case_platform/ods_team_member';
