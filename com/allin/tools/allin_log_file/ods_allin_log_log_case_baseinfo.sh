...
if [ $? -eq 0 ];then
    hive -e "alter table ods.ods_allin_log_log_case_baseinfo add if not exists partition(dt='"""${etl_date}"""');"
else
    exit 1
fi