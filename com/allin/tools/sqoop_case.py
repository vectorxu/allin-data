...
# 生成sqoop语句
def get_table():
    db = pymysql.connect(host="docker-base.mysql.rds.aliyuncs.com", user="case", password="zm$3BnA2x&pcne9W", port=3317,database="information_schema")
...
def get_colume(tablename):
   ...
   db1 = pymysql.connect(host="docker-base.mysql.rds.aliyuncs.com", user="case", password="zm$3BnA2x&pcne9W", port=3317,database="information_schema")
   cur = db1.cursor()
...
def write_file(filename,file):
   dir = "/Users/allin/PycharmProjects/allin-data/com/allin/tools/case_file/"
   path = dir+filename
